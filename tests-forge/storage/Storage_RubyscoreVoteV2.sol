...
abstract contract Storage_RubyscoreVoteV2 is Test {
    string public constant TEST_MNEMONIC = "test test test test test test test test test test test junk";

    uint256 public price = 1e9;
    uint256 public initialCounter = 1e3;
    address public owner = address(0xadfda);
    Harness_RubyscoreVoteV2 public voteContract;

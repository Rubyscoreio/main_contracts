...
import {
    Environment_RubyscoreID_Soneium,
    Environment_RubyscoreID_Katana
} from "tests-forge/environment/Environment_RubyscoreID.chains.sol";
...
contract Tester_Rubyscore_Katana_Id is Environment_RubyscoreID_Katana, Suite_RubyscoreID {}

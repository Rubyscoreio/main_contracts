...
/**
 * @title IRubyscore_Soneium_Badge
 * @dev IRubyscore_Soneium_Badge is an interface for Rubyscore_Soneium_Badge contract
 */
interface IRubyscore_Soneium_Badge is IERC1155 {
    struct MintParams {

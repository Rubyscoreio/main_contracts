...
import {ISoneium_Badge} from "./interfaces/ISoneium_Badge.sol";
 ...
 * @dev Soneium_Badge can be minted by users with the MINTER_ROLE after proper authorization.
 * @dev Soneium_Badge can have their URIs set by operators with the MINTER_ROLE.
 * @dev Soneium_Badge can be safely transferred with restrictions on certain tokens.
 */
contract Soneium_Badge is
    ERC1155,
    EIP712,
    AccessControl,
    ERC1155Supply,
    ...
    ISoneium_Badge
{
    ...
    function supportsInterface(
        bytes4 interfaceId
    ) public view override(ERC1155, AccessControl, ISoneium_Badge) returns (bool) {
    ...
    function uri(
        uint256 tokenId
    ) public view override(ERC1155, ERC1155URIStorage, ISoneium_Badge) returns (string memory) {
